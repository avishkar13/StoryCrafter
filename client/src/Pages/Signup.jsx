...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-slate-900 to-blue-900 px-4">
      <div className="bg-white/10 backdrop-blur-lg border border-white/20 shadow-2xl rounded-xl w-full max-w-md p-8">
        <h2 className="text-2xl font-bold mb-6 text-center text-white">Create your StoryCrafter account</h2>
        ...
        {step === 1 && (
          <form onSubmit={handleSubmit(onSendOtp)} className="space-y-4">
            <input
              ...
              required
              className="w-full px-4 py-2 border rounded-md bg-white backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <button
              type="submit"
        ...
        {step === 2 && (
          <form onSubmit={handleSubmit(onVerifyOtp)} className="space-y-4">
            <input
              ...
              required
              className="w-full px-4 py-2 border rounded-md bg-white backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-green-500"
            />
            <button
              type="submit"
        ...
        {step === 3 && (
          <form onSubmit={handleSubmit(onCompleteSignup)} className="space-y-4">
            <input
              ...
              required
              className="w-full px-4 py-2 border rounded-md bg-white backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
            />
            <input
              {...register('password')}
              type="password"
